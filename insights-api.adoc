...
Related Knowledgebase article on https://access.redhat.com/solutions/7063192[How to automate the process of assigning systems to groups/workspaces in Lightspeed?].
...
* https://console.redhat.com/docs/api[Lightspeed API Documentation] – Full list of endpoints and supported parameters.
